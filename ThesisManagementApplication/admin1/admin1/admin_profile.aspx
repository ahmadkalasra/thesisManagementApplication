<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="admin_profile.aspx.cs" Inherits="admin1.admin_profile" %>
<!DOCTYPE html>
<html lang="en">
<head>
 ...
 <div class="navbar-header" >
    ...
    <div class="navbar-collapse collapse" >
      <ul class="nav navbar-nav navbar-right"  >
        <li class="dropdown" >
        <a href="#" style="background-color:transparent;" id="dropd" class="dropdown-toggle" data-toggle="dropdown"> <span  class="glyphicon glyphicon-user icon-size"></span><asp:Literal ID="Literal1" runat="server" ></asp:Literal><span class="caret"></span></a>

                  <ul class="dropdown-menu pull-left" style="background-color:#7a8c74; border-color:#7a8c74; padding:0px; margin:0px;" role="menu">
                    <li class="hidden-sm hidden-xs" id="profpic"><a href="#" id="profpica" ><img src="img/pic.png" style="width:75px;height:75px; padding:10px;" /><br /><asp:Literal ID="Literal3" runat="server" ></asp:Literal><br /><span style="word-break:break-all;"><asp:Literal ID="Literal2" runat="server" ></asp:Literal></span></a></li>
...
<h1 class="page-header"><span class="glyphicon glyphicon-user"></span> Admin Panel - Profile</h1>
 ...
 <br />
    ...
    <tr>
      ...
      <th>Access</th>
      <td><asp:Literal ID="access" runat="server" ></asp:Literal></td>
      <th>Designation</th>
      <td><asp:Literal ID="designation" runat="server" ></asp:Literal></td>
      <td rowspan="7"></td>
    ...
    <tr>
      ...
      <td colspan="3"><asp:Literal ID="uemial" runat="server" ></asp:Literal></td>
    </tr>
    ...
    <tr>
      ...
      <th>Extension</th>
      <td colspan="3"><asp:Literal ID="ext" runat="server" ></asp:Literal></td>
    </tr>
    <tr>
