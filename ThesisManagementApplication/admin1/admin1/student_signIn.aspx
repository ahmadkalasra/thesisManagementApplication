<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="student_signIn.aspx.cs" Inherits="admin1.student_signIn" %>
...
<div class="container-fluid" style="padding-top:30px; height:100%; overflow:auto; text-align:center; ">
 <form runat="server">
<h1 class="page-header"><span class="glyphicon glyphicon-user"></span> Student Panel - Login</h1>
 ...
 <br />
  ...
  <label  for="selectbasic" style="text-align:left;padding-top:5px;">Enrollment</label>
        </div>
    <div class="row" style="margin:0 auto; text-align:center; max-width:425px;">
    <div class="input-group">
					<span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
                    <asp:TextBox ID="enrollment" placeholder="ENROLLMENT" type="text" class="form-control input-md" runat="server"></asp:TextBox>
				</div></div><br />
  ...
  <label  for="selectbasic" style="text-align:left;padding-top:5px;">Password</label>
    ...
    <br />
    <div class="row" style="margin:0 auto; text-align:center; max-width:425px;">
  <asp:Button ID="login" runat="server" Text="Sign In" class="btn btn-primary" OnClick="login_Click" style="width:425px;"  />
        </div><br />
