<%@ Page Title="Home Page" Language="C#" AutoEventWireup="true" CodeBehind="Home.aspx.cs" Inherits="admin1._Default" %>
...
<h1 class="page-header"><span class="glyphicon glyphicon-user"></span> Student Panel</h1>
  ...
  <table class="table table-bordered" >
    ...
    <tr>
      ...
      <th>Father Name</th>
      <td colspan="3"><asp:Literal ID="Literal5" runat="server" ></asp:Literal></td>
    </tr>
    <tr>
      <th>Class</th>
      <td><asp:Literal ID="Literal6" runat="server" ></asp:Literal></td>
      <th>Degree Duration</th>
      <td colspan="3"><asp:Literal ID="Literal7" runat="server" ></asp:Literal></td>
    </tr>
    <tr>
      <th>Mobile</th>
    ...
    <th>Current Address</th>
      <td colspan="5"><asp:Literal ID="Literal11" runat="server" ></asp:Literal></td>
    </tr>
    <tr>
    <th>Permanent Address</th>
      <td colspan="5"><asp:Literal ID="Literal12" runat="server" ></asp:Literal></td>
    </tr>
    <tr>
    <th>Community Support Work:</th>
      <td colspan="5"><asp:Literal ID="Literal13" runat="server" ></asp:Literal></td>
    </tr>
